...
<body>
    ...
    if (cart.length === 0) {
        ...
        cartList.appendChild(emptyMessage); //add message if cart is empty
    } else {
    ...
    document.getElementById("total-price").textContent = totalPrice.toFixed(2); //add total price tracker
}
//card information
